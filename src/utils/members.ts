...
export const DECORATIONS = {
  CROWN: (gender: string) => ({
    src:
      gender === "GIRL" ? "/images/pages/members/decorations/crownpink.png" : "/images/pages/members/decorations/crown.png",
    className:
      gender === "GIRL"
  ...
  MIC: {
    src: "/images/pages/members/decorations/mic.png",
    className: "mic absolute bottom-[3rem] -right-[1rem] w-[7rem] h-auto",
  },
  VIKING: {
    src: "/images/pages/members/decorations/viking.png",
    className: "viking absolute -top-[3rem] right-[2.22rem] w-[7rem] h-auto",
  },
  BOOK: {
    src: "/images/pages/members/decorations/book.png",
    className: "book absolute bottom-[3.5rem] -right-[0rem] w-[7rem] h-auto",
  },
  MONEY: {
    src: "/images/pages/members/decorations/money.png",
    className: "money absolute bottom-[4.2rem] right-[0rem] w-[6rem] h-auto",
  },
  HOUSE: (gender: string) => ({
    src:
      gender === "GIRL"
        ? "/images/pages/members/decorations/housepink.png"
        : "/images/pages/members/decorations/houseblue.png",
    className:
      gender === "GIRL"
  ...
  LEAF: {
    src: "/images/pages/members/decorations/leaf.png",
    className: "leaf absolute bottom-[4.5rem] right-[1rem] w-[4rem] h-auto",
  },
  PAINT: (gender: string) => ({
    src:
      gender === "GIRL"
        ? "/images/pages/members/decorations/paintpink.png"
        : "/images/pages/members/decorations/paintblue.png",
    className:
      gender === "GIRL"
  ...
  CAMERA: {
    src: "/images/pages/members/decorations/camera.png",
    className: "camera absolute bottom-[4.2rem] -right-[0rem] w-[6rem] h-auto",
  },
  STATUE: (gender: string) => ({
    src:
      gender === "GIRL"
        ? "/images/pages/members/decorations/statuepink.png"
        : "/images/pages/members/decorations/statueblue.png",
    className:
      gender === "GIRL"
  ...
  MEGAPHONE: {
    src: "/images/pages/members/decorations/megaphone.png",
    className: "megaphone absolute bottom-[4rem] -right-[1rem] w-[7rem] h-auto",
  },
  LAPTOP: (gender: string) => ({
    src:
      gender === "GIRL"
        ? "/images/pages/members/decorations/laptoppink.png"
        : "/images/pages/members/decorations/laptopblue.png",
    className:
